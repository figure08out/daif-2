...
const CountUp: React.FC<CountUpProps> = ({ end, duration = 2, suffix = "", ...props }) => {
  ...
  return <span {...props}>{count}{suffix}</span>;
};
...
function ImageSlideshow() {
  ...
  const images = [
    "https://auth.knowtice.ai/storage/v1/object/public/daif-images//IMG_7912.JPG",
    "https://auth.knowtice.ai/storage/v1/object/public/daif-images//IMG_7914.JPG",
    "https://auth.knowtice.ai/storage/v1/object/public/daif-images//IMG_7985.JPG",
    "/IMG-20250425-WA0117.webp"
  ];
  ...
  return (
    <div className="relative h-[750px] w-full overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 backdrop-blur-[5px] pointer-events-none"></div>
      {/* Content overlay */}
          <div className="absolute inset-0 flex flex-col items-center justify-center z-20 px-4 text-center">
            <div className="relative">
              {/* Simplified card with subtle blur */}
              <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-500/20 via-purple-600/20 to-blue-500/20 rounded-3xl blur-sm opacity-30 animate-gradient-x"></div>
              <div className="p-10 rounded-3xl backdrop-blur-[2px] bg-black/5 border border-white/10 max-w-3xl relative overflow-hidden shadow-2xl">
                {/* Decorative elements */}
                ...
                {/* Animated particles */}
                <div className="absolute w-2 h-2 rounded-full bg-blue-400/40 blur-sm top-10 left-10 animate-pulse-slow"></div>
                <div className="absolute w-3 h-3 rounded-full bg-purple-400/40 blur-sm bottom-20 right-14 animate-pulse-slow" style={{ animationDelay: '1s' }}></div>
                <div className="absolute w-2 h-2 rounded-full bg-indigo-400/40 blur-sm top-32 right-28 animate-pulse-slow" style={{ animationDelay: '2s' }}></div>
                <div className="absolute w-2 h-2 rounded-full bg-blue-400/40 blur-sm bottom-14 left-24 animate-pulse-slow" style={{ animationDelay: '1.5s' }}></div>
...
// Modify TypingText component to be faster
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#0f0f1d] text-white overflow-x-hidden">
      ...
      <nav className="flex justify-between items-center px-8 py-4 sticky top-0 z-50 backdrop-blur-md bg-[#13131f]/90 border-b border-indigo-900/30">
      ...
      <section ref={statsRef} id="number-stats" className={`py-16 relative overflow-hidden bg-[#0f0f1d] transition-all duration-1000 transform ${statsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="absolute inset-0 bg-gradient-to-b from-[#13131f] to-[#151525] opacity-90"></div>
        {/* Decorative elements */}
      ...
      <section ref={productsRef} id="products" className={`py-20 px-4 relative overflow-visible bg-[#0f0f1d] transition-all duration-1000 transform ${productsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="inline-block mx-auto mb-16 px-8 py-4 bg-transparent rounded-xl">
            ...
            <div className="h-1 w-32 mx-auto mt-3 bg-gradient-to-r from-blue-500 via-purple-500 to-indigo-500 rounded-full"></div>
      ...
      <section ref={icymiRef} id="icymi" className={`py-20 px-4 relative overflow-hidden bg-[#0f0f1d] transition-all duration-1000 transform ${icymiVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-[#13131f] to-[#151525] opacity-90"></div>
      ...
      <section ref={globalReachRef} id="global-reach" className={`py-20 px-4 relative overflow-hidden transition-all duration-1000 transform ${globalReachVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="connection-card bg-[#151525] rounded-xl border border-indigo-900/40 p-8 flex flex-col shadow-lg opacity-0 translate-y-6 animate-fadeInUp" style={{ animationDelay: `0.2s`, animationFillMode: 'forwards' }}>
              ...
              <div className="text-white text-lg font-medium mb-6">
                <TypingText text="SinX was one of five companies we were recommended to meet at this event — they stood out for all the right reasons." speed={5} delay={100} />
                              </div>
            ...
            <div className="connection-card bg-[#151525] rounded-xl border border-indigo-900/40 p-8 flex flex-col shadow-lg opacity-0 translate-y-6 animate-fadeInUp" style={{ animationDelay: `0.3s`, animationFillMode: 'forwards' }}>
              <div className="text-blue-400 text-3xl mb-4">&ldquo;</div>
              <div className="text-white text-lg font-medium mb-6">
                <TypingText text="As someone who worked as an account manager in the UK, I was elated to find how useful MCG is — it's exactly the kind of tool someone new to the UAE job market needs when trying to pivot." speed={5} delay={200} />
                      </div>
              <div className="flex items-center gap-3 mt-auto">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center text-white font-bold text-xl">
                  R
            ...
            <div className="connection-card bg-[#151525] rounded-xl border border-indigo-900/40 p-8 flex flex-col shadow-lg opacity-0 translate-y-6 animate-fadeInUp" style={{ animationDelay: `0.4s`, animationFillMode: 'forwards' }}>
              <div className="text-blue-400 text-3xl mb-4">&ldquo;</div>
              <div className="text-white text-lg font-medium mb-6">
                <TypingText text="Intelligence OS has transformed how we handle personalization and bundling. Our AOV increased by 32% within the first month of implementation. The ROI speaks for itself." speed={5} delay={300} />
                      </div>
              <div className="flex items-center gap-3 mt-auto">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center text-white font-bold text-xl">
                  M
        ...
        <div className="max-w-[1024px] mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
            ...
            <div className="rounded-2xl bg-[#18182a] border border-blue-900/40 shadow-lg p-8 flex flex-col h-full">
              ...
              <div className="rounded-xl overflow-hidden mb-4 aspect-video bg-black flex items-center justify-center">
                <Image src="/IMG_7914.jpg" alt="SinX Solutions Twitter Post" width={600} height={800} className="w-full" style={{height: '32rem', objectFit: 'cover'}} />
            </div>
              <div className="mt-auto">
      ...
      <section ref={whatsNextRef} id="whatsnext" className={`py-24 px-4 relative overflow-hidden bg-[#0f0f1d] transition-all duration-1000 transform ${whatsNextVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="absolute inset-0 bg-gradient-to-b from-[#15152a] to-[#13131f] opacity-90"></div>
      ...
      {/* Feedback Section */}
      <section ref={feedbackRef} id="feedback" className={`py-20 px-4 relative overflow-hidden transition-all duration-1000 transform ${feedbackVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="absolute inset-0 bg-gradient-to-b from-[#0f0f1d] via-[#13131f] to-[#0f0f1d] opacity-95"></div>
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-purple-600/10 rounded-full blur-3xl"></div>
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-blue-600/10 rounded-full blur-3xl"></div>
